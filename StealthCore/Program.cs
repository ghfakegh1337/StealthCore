...
class Program
{
    ...
    static async Task Rust(string directoryPath)
    {
        ...
        do
        {
            ...
            {
                Console.WriteLine("Вы ввели неверную команду. Если вы хотите все очистить, напишите 'clear'.");
            }
    ...
    static async Task CS2(string directoryPath)
    {
        ...
        // Запускаем инжектор CS2
        открытиеПрограммыПоНазванию(directoryPath + "\\" + CS2InjectorRandomFileName);
